...
function AddCategories(props) {
    ...
    const handleSubmit = (e) => {
        ...
        if (!flag) {
            ...
            axios
                .post(' http://localhost:8080/api/auth/Admin/AddCategories', data)
                .then((res) => {
                ...
                <div className={styles.overlay}>
                    <div className={styles.popup}>
                        <form className={styles.form_container} onSubmit={handleSubmit}>
                            ...
                            <input type="text" placeholder="Name" name="name" value={categoryName} onChange={(e) => setCategoryName(e.target.value)} required />
